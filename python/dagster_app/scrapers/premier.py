...
class PremierScraper(BaseScraper):
    ...
    def scrape(self) -> Iterator[ProductRow]:
        for slug in ("catalog/smartfony", "smartphones", "catalog/telefony"):
            page = 1
            found_any = False
            while page <= 15:
                try:
                    ...
                    logger.warning(f"[premier] /{slug} page {page} error: {exc}")
                    break
                page += 1
            if found_any:
                break
