export const ru = {
  ...
  listing: {
    ...
    totalProductsCount: "{{count}} товаров",
    shownProducts: "— Показано {{count}} товаров —",
    showLess: "↑ Свернуть",
    showAll: "↓ Все ({{count}})",
  ...
  trends: {
    title: "Анализ рынка",
    subtitle: "Поисковые запросы, тренды и статистика маркетплейсов за последние 7 дней",
    totalProducts: "Всего товаров",
    marketplaces: "Маркетплейсы",
    weeklyActivity: "Недельная активность",
    priceDrops: "Снижение цен",
    topSearches: "Популярные запросы (7 дней)",
    noSearchData: "Данные по запросам пока отсутствуют",
    marketRanking: "Рейтинг маркетплейсов",
    productsCount: "{{count}} товаров",
    product: "Товар",
    avgPriceUzs: "Средняя цена (сум)",
    priceChanges: "Изменения цен (3 дня)",
    priceDropped: "Цена снизилась",
    noData: "Нет данных",
    priceIncreased: "Цена выросла",
    mostViewed: "Популярные просмотры (7 дней)",
    marketShare: "Доля маркетплейсов",
  },

  feedback: {
    title: "Обратная связь",
    leaveFeedback: "Оставить отзыв",
    subtitle: "Помогите нам улучшить сайт",
    emptyMessageError: "Пожалуйста, напишите ваш отзыв",
    submitError: "Произошла ошибка при отправке. Пожалуйста, попробуйте еще раз",
    ratingRequiredError: "Пожалуйста, выберите оценку",
    invalidEmailError: "Пожалуйста, введите корректный адрес электронной почты",
    thankYou: "Спасибо!",
    successMessage: "Ваш отзыв принят. Ваше мнение очень важно для нас.",
    ...
    textareaPlaceholder: "Напишите ваши предложения, жалобы или отзывы здесь...",
    sending: "Отправка...",
    send: "Отправить",
  },
};
