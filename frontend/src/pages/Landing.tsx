  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 pb-24 md:pb-0 transition-colors">
        ...
        <div className="px-4 max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {MARKET_LOGOS.map(({ name, color }) => (
              <div
                key={name}
                className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl px-5 py-3 shadow-sm hover:shadow-md transition-shadow"
              >
      ...
      <section className="mt-10 px-4 max-w-7xl mx-auto">
        <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 md:p-12 border border-blue-100 dark:border-blue-950 shadow-xl shadow-blue-500/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 rounded-2xl bg-[#0062FF]/10 dark:bg-[#0062FF]/20 text-[#0062FF]">
                <TrendingUp size={24} />
              </div>
              <div>
              ...
              {loadingRecs ? (
                ...
                recommendations.map((p) => (
                  <Link
                    key={p.id}
                    to={`/product/${p.id}`}
                    className="group bg-gray-50 dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-750 p-5 rounded-3xl border border-gray-100 dark:border-gray-700 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-xl transition-all duration-300"
                  >
      ...
      {/* ── How it works ── */}
      <section className="mt-14 md:mt-20 bg-gray-50 dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800 py-12 md:py-16">
        <div className="px-4 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {t.landing.howItWorks.steps.map((item, idx) => (
              <div
                key={idx}
                className="relative bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                {idx < 2 && (
                  <div className="hidden md:block absolute top-10 -right-4 z-10 text-gray-300 dark:text-gray-600">
