      ...
      <div className="py-3">
        ...
        <div className="space-y-0.5">
          {BRANDS.map(brand => {
            ...
            return (
              <button key={brand} type="button" onClick={() => setSelectedBrand(on ? null : brand)}
              ...
              >
                <Cb on={on} />
                <span className="w-2 h-2 rounded-full shrink-0" style={{ backgroundColor: BRAND_COLORS[brand] ?? '#9ca3af' }} />
      ...
      <div className="py-3">
        ...
        <div className="space-y-0.5">
          {visibleMarkets.map(({ name, key, color }) => {
            ...
            return (
              <button key={key} type="button" onClick={() => toggleMarketplace(key)}
                className="flex w-full items-center gap-2 rounded px-1.5 py-[7px] text-left hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors group"
              >
                <Cb on={on} />
